...
clam2switchboard --url https://webservices.cls.ru.nl/frog -l nld --task "NLP suite for Dutch" #I don't like this task's title, Frog supports multiple tasks (see https://github.com/clarin-eric/switchboard/issues/67 and https://github.com/clarin-eric/switchboard-tool-registry/issues/5)
clam2switchboard --url https://webservices.cls.ru.nl/ucto --task "Tokenisation"
clam2switchboard --url https://webservices.cls.ru.nl/piereling --task "Data Conversion"
clam2switchboard --url https://webservices.cls.ru.nl/alpino -l nld --task "Dependency Parsing"
clam2switchboard --url https://webservices.cls.ru.nl/colibricore --task "N-Gramming"
clam2switchboard --url https://webservices.cls.ru.nl/eng_ASR -l eng --task "Speech Recognition"
clam2switchboard --url https://webservices.cls.ru.nl/oralhistory -l nld --task "Speech Recognition"
clam2switchboard --url https://webservices.cls.ru.nl/spreek2schrijf -l nld --task "Speech Recognition"
clam2switchboard --url https://webservices.cls.ru.nl/forcedalignment2 -l nld --task "Speech Recognition"

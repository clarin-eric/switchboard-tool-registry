[![CI](https://github.com/clarin-eric/switchboard-tool-registry/workflows/CI/badge.svg?branch=production)](https://github.com/clarin-eric/switchboard-tool-registry/actions?query=workflow%3ACI+branch%3Aproduction)
